...
function ConteoNotificacionesUsuario()
{
    ...
    {
        fetch(`http://localhost:8080/notificaciones/conteo`,
            {
                method: 'GET',
                headers: {
...
function MarcarLeidas()
{
    if (localStorage.getItem("logged") !== null)
        {
            fetch(`http://localhost:8080/notificaciones/marcarleidas`,
                {
                    method: 'PUT',
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem("logged")}`,
...
function NotificacionesUsuario(limit = 20, offset = 0)
{
    if (localStorage.getItem("logged"))
    {
        fetch(`http://localhost:8080/notificaciones/usuario`,
            {
                method: 'POST',
                body: JSON.stringify(
                    {
...
function DatosUsuario()
{
    ...
    fetch(`http://localhost:8080/usuario/datos`,
        {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem("logged")}`,
