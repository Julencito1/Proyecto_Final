...
function VideosCategoria(offset = 0) {
    ...
    const timeout = setTimeout(() => {
        ...
        contenedor_videos_inicio.appendChild(loaderResultados)
    ...
    .then((datos) => {
                            ...
                            for (let k = 0; k < videos.length; k++)
                                {
                                    ...
                                    recomendacion.classList.add("flex", "flex-col", "gap-2", "w-full")
        ...
        } catch(error)
        {
            ...
            if (loaderResultados)
            {
                contenedor_videos_inicio.removeChild(loaderResultados)
            }
