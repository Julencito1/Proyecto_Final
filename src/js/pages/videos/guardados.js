...
function VideosGuardados(limit = limitActual, offset = offsetActual, filtro = filtroActual, buscar = "")
{
    ...
    fetch("http://localhost:8080/videos/guardados/obtener",
        {
            method: 'POST',
            body: JSON.stringify({
                limit: limit,
                            ...
                            nuevoContenedor.innerHTML = `
                                ...
                                <div class='flex gap-4 w-full group'>
                                    <div class='w-[170px] h-[100px] relative'>
                                        <img src='${datos.mensaje.contenedor[i].video.media.miniatura}' class='rounded-md bg-cover bg-no-repeat bg-center w-[170px] h-[100px]'>
...
function QuitarVideo(identificador)
{
    ...
    fetch("http://localhost:8080/videos/guardados/borrar",
        {
            method: 'DELETE',
            body: JSON.stringify({
