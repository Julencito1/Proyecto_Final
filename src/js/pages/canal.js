...
function DatosCanal() {
    ...
    fetch(`https://proyectofinalapi-production-0ce0.up.railway.app/canales/datos`,
        {
            method: 'POST',
            headers: {
...
function VideosCanal(limit = 20, offset = 0)
{
    ...
    fetch(`https://proyectofinalapi-production-0ce0.up.railway.app/canal/videos`,
        {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem("logged")}`,
                            ...
                            <div class='flex gap-6'>
                                ...
                                <div class='relative ml-auto' id='contenedor_sp_${m + offset}'>
                                    ...
                                    <div id='submenu_${m + offset}' class='absolute flex flex-col w-44 p-1 rounded-md bg-white z-20 right-0 shadow-md border hidden origin-top-right'>
                                        ...
                                        `}
                                        <button onclick="navigator.clipboard.writeText('https://newtube-tp1f.onrender.com/pages/videos.html?ref=${e.canal.videos.link.ruta}'); event.stopPropagation(); event.preventDefault();" class='flex items-center gap-2 font-Inter text-xs w-full text-left rounded-md transition-colors duration-150 p-1.5 hover:bg-gray-100'>
                                            <div>
...
function SobreMi()
{
    ...
    fetch(`https://proyectofinalapi-production-0ce0.up.railway.app/canal/sobremi`,
        {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem("logged")}`,
...
function ActualizarDescripcionCanal()
{
    ...
    fetch("https://proyectofinalapi-production-0ce0.up.railway.app/canal/actualizar/descripcion",
        {
            method: 'PUT',
            body: JSON.stringify({
                canal: canal,
...
function VideosPrivadosCanal(limit = 20, offset = 0)
{
    ...
    fetch(`https://proyectofinalapi-production-0ce0.up.railway.app/canal/videos/privados`,
        {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem("logged")}`,
...
function HacerPublicoVideo(identificador)
{
    ...
    fetch("https://proyectofinalapi-production-0ce0.up.railway.app/canal/videos/publicar",
        {
            method: 'PUT',
            body: JSON.stringify({
                canal: canal,
...
function OcultarVideo(identificador)
{
    ...
    fetch("https://proyectofinalapi-production-0ce0.up.railway.app/canal/videos/ocultar",
        {
            method: 'PUT',
            body: JSON.stringify({
                canal: canal,
...
function BorrarVideo(identificador)
{
    ...
    fetch("https://proyectofinalapi-production-0ce0.up.railway.app/canal/videos/borrar",
        {
            method: 'DELETE',
            body: JSON.stringify({
                canal: canal,
...
function InicioCanal()
{
    ...
    fetch("https://proyectofinalapi-production-0ce0.up.railway.app/canal/videos/inicio",
        {
            method: 'POST',
            body: JSON.stringify({
                canal: canal,
