...
<div id="header" class="px-4 py-2 flex items-center justify-between">
      <div>
        <div class="flex items-center gap-1">
          <button aria-label="Botón Menu Sidebar" id="btn_sidebar" class="p-2 max-md:hidden rounded-full cursor-pointer transition-colors duration-150 hover:bg-[#f2f2f2]">
